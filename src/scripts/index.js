...
document
  .querySelector("#close-edit-project-modal")
  .addEventListener("click", () => {
...
document
  .querySelector("#close-add-project-modal")
  .addEventListener("click", () => {
...
document.querySelector("#submit-edit-task").addEventListener("click", () => {
  if (taskToEdit) {
    ...
    taskToEdit.description = document
      .querySelector("#edit-task-desc")
      .value.trim(); // Update description
...
document.querySelector("#submit-edit-project").addEventListener("click", () => {
  ...
  if (newProjectName && projects[currentProject]) {
    ...
    document.querySelector("#current-project-name").textContent =
      currentProject; // Update the displayed project name
    renderProject(); // Re-render the projects list
...
function deleteProject(projectName) {
  if (projects[projectName]) {
    ...
    if (currentProject === projectName) {
      ...
      document.querySelector("#current-project-name").textContent =
        currentProject; // Update the current project name
    }
    renderProject(); // Re-render the projects list
    renderTask(); // Re-render the tasks
